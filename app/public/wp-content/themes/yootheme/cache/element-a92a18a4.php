<?php // $file = C:/Users/luisf/Local Sites/next/app/public/wp-content/themes/yootheme/vendor/yootheme/builder/elements/popover/element.json
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['drop_mode', 'drop_position', 'drop_width', 'card_style', 'card_link', 'card_size']
            ], [
              'label' => 'Title', 
              'type' => 'group', 
              'divider' => true, 
