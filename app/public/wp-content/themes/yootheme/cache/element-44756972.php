<?php // $file = C:/Users/luisf/Local Sites/next/app/public/wp-content/themes/yootheme/vendor/yootheme/builder/elements/grid/element.json
...
return [
  ...
  'fields' => [
    ...
    'panel_content_width' => [
      ...
      'show' => '!panel_style', 
      'enable' => 'show_image && image_align == \'top\' && !panel_content_padding && !item_maxwidth && (!grid_default || grid_default == \'1\') && (!grid_small || grid_small == \'1\') && (!grid_medium || grid_medium == \'1\') && (!grid_large || grid_large == \'1\') && (!grid_xlarge || grid_xlarge == \'1\')'
    ], 
    'title_style' => [
      'label' => 'Style', 
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['panel_style', 'panel_link', 'panel_content_padding', 'panel_size', 'panel_card_image', 'item_maxwidth', 'panel_content_width']
            ], [
              'label' => 'Title', 
              'type' => 'group', 
              'divider' => true, 
              ...
              'label' => 'General', 
              'type' => 'group', 
              'fields' => ['position', 'position_left', 'position_right', 'position_top', 'position_bottom', 'position_z_index', 'margin', 'margin_remove_top', 'margin_remove_bottom', 'maxwidth', 'maxwidth_breakpoint', 'block_align', 'block_align_breakpoint', 'block_align_fallback', 'text_align', 'text_align_breakpoint', 'text_align_fallback', 'animation', 'item_animation', '_parallax_button', 'visibility']
            ]]
