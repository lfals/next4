<?php // $file = C:/Users/luisf/Local Sites/next/app/public/wp-content/themes/yootheme/vendor/yootheme/theme/config/customizer.json
  ...
  'panels' => [
    ...
    'header' => [
      ...
      'fields' => [
        ...
        'navbar.toggle_menu_divider' => [
          'type' => 'checkbox', 
          'text' => 'Show dividers', 
          'enable' => '$match(header.layout, \'^offcanvas\') || $match(header.layout, \'^modal\')'
        ], 
