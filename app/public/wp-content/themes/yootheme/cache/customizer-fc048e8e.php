<?php // $file = C:/Users/luisf/Local Sites/next/app/public/wp-content/themes/yootheme/vendor/yootheme/theme-cookie/config/customizer.json
    ...
    'cookie' => [
      ...
      'fields' => [
        ...
        'cookie.custom_js' => [
          ...
          'description' => 'Add custom JavaScript which sets cookies. It will be loaded after consent is given. The &lt;script&gt; tag is not needed.', 
          'type' => 'editor', 
          'editor' => 'code', 
          'mode' => 'javascript', 
          'enable' => 'cookie.mode && cookie.mode == "consent"'
